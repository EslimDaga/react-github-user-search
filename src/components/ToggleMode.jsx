    ...
    <div className="transition duration-500 ease-in-out rounded-full">
      {theme === "dark" ? (
        <button
          ...
          className="flex cursor-pointer items-center font-space font-bold text-sm tracking-[.2em] dark:text-white dark:fill-white hover:dark:text-color-text-third-dark hover:dark:fill-color-text-third-dark"
        >
          LIGHT
          <svg
            className="ml-4"
        ...
        <button
          onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
          className="flex cursor-pointer items-center font-space font-bold text-sm tracking-[.2em] text-color-text-second-light hover:text-color-text-third-light fill-color-text-second-light hover:fill-color-text-third-light"
        >
          DARK
          <svg
            className="ml-4"
